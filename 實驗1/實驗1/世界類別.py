...
class 世界類別:
    ...
    def 更新涵蓋率(self):
        self.植物涵蓋率 = len(self.植物列表) / N_WORLD_HEIGHT / N_WORLD_WIDTH * 100
        self.草地涵蓋率 = len(self.草地列表) / N_WORLD_HEIGHT / N_WORLD_WIDTH * 100
        self.腐化植物涵蓋率 = len(self.腐化植物列表) / N_WORLD_HEIGHT / N_WORLD_WIDTH * 100
