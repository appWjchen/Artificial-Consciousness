                ...
                for 氣味 in 氣味列表:
                    ...
                    if 氣味.大小 > 0:
                        if 氣味.方向 == 氣味類別.方向無:  # 更新氣味大小
                            ...
                            氣味右下 = self.產生傳播氣味(x + 1, y + 1, 氣味類別.方向右下, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味右下.x][氣味右下.y].append(氣味右下)
                        elif 氣味.方向 == 氣味類別.方向右下:
                            # 在三個方向(右, 右下, 下)形成新的傳播氣味
                            氣味右 = self.產生傳播氣味(x, y + 1, 氣味類別.方向右, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味右.x][氣味右.y].append(氣味右)
                            氣味右下 = self.產生傳播氣味(x + 1, y + 1, 氣味類別.方向右下, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味右下.x][氣味右下.y].append(氣味右下)
                            ...
                            氣味左下 = self.產生傳播氣味(x + 1, y - 1, 氣味類別.方向左下, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味左下.x][氣味左下.y].append(氣味左下)
                        elif 氣味.方向 == 氣味類別.方向左下:
                            # 在三個方向(下, 左下, 左)形成新的傳播氣味
                            氣味下 = self.產生傳播氣味(x + 1, y, 氣味類別.方向下, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味下.x][氣味下.y].append(氣味下)
                            氣味左下 = self.產生傳播氣味(x + 1, y - 1, 氣味類別.方向左下, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味左下.x][氣味左下.y].append(氣味左下)
                            ...
                            氣味左上 = self.產生傳播氣味(x - 1, y - 1, 氣味類別.方向左上, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味左上.x][氣味左上.y].append(氣味左上)
                        elif 氣味.方向 == 氣味類別.方向左上:
                            # 在三個方向(左, 左上, 上)形成新的傳播氣味
                            氣味左 = self.產生傳播氣味(x, y - 1, 氣味類別.方向左, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味左.x][氣味左.y].append(氣味左)
                            氣味左上 = self.產生傳播氣味(x - 1, y - 1, 氣味類別.方向左上, 氣味.大小, 氣味.來源)
                            新氣味場格子[氣味左上.x][氣味左上.y].append(氣味左上)
